...
import type { ReportSummary } from "@/lib/utils";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Layers, Target, Flag, ListChecks, Percent, AlertOctagon } from "lucide-react";
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{summary.totalPillars}</div>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
