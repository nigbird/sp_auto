  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "group hidden md:flex flex-col flex-shrink-0 text-sidebar-foreground bg-sidebar border-r border-sidebar-border transition-all ease-in-out duration-300 h-screen sticky top-0",
